...
class PasswordChangeDoneView(PasswordContextMixin, TemplateView):
    ...
    def success_url(self):
        messages.success(self.request, f'Your password was change successfully')
        return HttpResponseRedirect(reverse_lazy('profile-detail', args=(), kwargs={'slug': self.request.user.profile.slug}))
